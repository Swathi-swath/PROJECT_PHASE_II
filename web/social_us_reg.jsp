                        ...
                        <div class="contact_form_inner">
                           ...
                           <div class="form_contact">
                              ...
                              <form action="reg">
                                 ...
                                 <div class="field">
                                     <h1>REGISTRATION</h1>
                                     <br><br> <h1>USER ID<input type="text" name="usrid" value="" /></h1>
                                     <br><br> <h1>PASSWORD<input type="password" name="pwd" value="" /></h1>
                                     <br><br> <h1>EMAIL<input type="text" name="email" value="" /></h1>
                                     <br><br> <h1>mobile number<input type="text" name="mob" value="" /></h1>
                                     
                                     <div class="field">
                                     <br><br>  <button class="field_bt">REGISTER</button>
                                    </div>
                                    </div>
                                     <br><br> 
